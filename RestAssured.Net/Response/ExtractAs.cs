// <copyright file="ExtractAs.cs" company="On Test Automation">
...
{
    /// <summary>
    /// Contains the different options for forcing value extraction from a specific format.
    /// </summary>
    public enum ExtractAs
    {
        /// <summary>
